  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="nav-desktop-links" style={{ flex: 1, display: 'flex', justifyContent: 'center', gap: 4 }}>
      ...
      <div className={`mobile-menu${open ? ' is-open' : ''}`}>
        ...
        <div style={{ display: 'flex', gap: 20, paddingTop: 18, alignItems: 'center' }}>
          <a href={CONTACT.linkedinUrl} target="_blank" rel="noreferrer" aria-label="LinkedIn" style={{ color: 'var(--ink)', display: 'flex' }}>
            <LinkedInIcon />
          </a>
          <a href={CONTACT.github} target="_blank" rel="noreferrer" aria-label="GitHub" style={{ color: 'var(--ink)', display: 'flex' }}>
          ...
          <a
            ...
            style={{ marginLeft: 'auto', fontFamily: 'var(--sans)', fontSize: 13, color: 'var(--ink)', textDecoration: 'none' }}
          >
            {CONTACT.email}
          </a>
        </div>
